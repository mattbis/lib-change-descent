...
- prefer Python and C style snake case methods ( sorry but its easier to read Node.js and JS has this wrong.. ) this way its easy to see what is built-in and what is a layer ontop... This library is very low-level... 
