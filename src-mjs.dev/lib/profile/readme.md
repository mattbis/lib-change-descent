...
### profiles - base classes

- base from these for a storage type programmatically... depending on a discover,, TODO (matt): this would need to still require a response

the library doesn't know anything but the parameters you give it... this dir enables not needing to create your own profiles and make mistakes...
