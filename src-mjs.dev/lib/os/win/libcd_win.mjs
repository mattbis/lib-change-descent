/**
 * Consolidated Windows platform integration module (`libcd_win.mjs`).
 * Bridges administrator elevation checks, disk wmic volume fingerprinting, and dynamic WFP firewall process isolation.
 */
